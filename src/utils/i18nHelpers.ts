    ...
    return new Proxy({}, {
      get: (target, prop) => {
        if (typeof prop === 'string') {
          ...
          const nestedObjectKeys = ['emptyState', 'placeholders', 'tooltips', 'deleteConfirmation', 'insights', 'statCards', 'sections', 'metrics', 'timeRange', 'tabs', 'dateLabels', 'selection', 'emptyStates', 'deleteModal', 'recurrenceTypes', 'priority', 'visibility'];
