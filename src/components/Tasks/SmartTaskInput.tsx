...
import { Plus, Lightbulb, Clock, Tag, Calendar, AlertCircle, CheckCircle, Sparkles, HelpCircle } from 'lucide-react';
...
export function SmartTaskInput({ placeholder, autoFocus = false, onTaskCreated, projectId, kanbanColumnId, targetColumnId }: SmartTaskInputProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!targetColumn && !projectId && (!columns.find((col: Column) => col.id === task.columnId))) {
    ...
    const newTask = {
      ...
      tags: task.tags,
      subtasks: [],
      columnId: projectId ? undefined : finalColumnId, // Für Projekt-Aufgaben kein columnId, sonst final column
              ...
              {parseResult.success ? (
                <div className="mt-3 space-y-2">
                  <div className="flex items-center text-sm text-green-600 dark:text-green-400">
                    ...
                    <span>Aufgabe bereit zum Erstellen</span>
                    {isQuickMode && (
